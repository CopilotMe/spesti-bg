...
const sources = [
  ...
  {
    icon: BadgeEuro,
    title: "Евро конвертор",
    source: "Фиксиран курс 1 EUR = 1.95583 BGN + Потребителска кошница (КНСБ)",
    url: null,
    frequency: "Непрекъснато (фиксиран курс), месечно (кошница)",
    method:
      "Конверсията BGN↔EUR е по официалния фиксиран курс. Проверката за честност на цените сравнява текущите евро цени на 21 продукта от кошницата с конвертираните предишни BGN цени, за да покаже дали е имало закръгляне нагоре.",
  },
  {
    icon: Globe,
    title: "България vs ЕС",
    source: "Eurostat (earn_mw_cur, lc_lci_lev, nrg_pc_204, prc_hicp_manr)",
    url: "https://ec.europa.eu/eurostat",
    frequency: "Автоматично (revalidate: 24 часа)",
    method:
      "Данните за минимални заплати, часова цена на труда, цени на електричество и инфлация се зареждат автоматично от Eurostat REST API. Сравняваме България с Румъния, Германия, Гърция, Хърватия и средното за ЕС-27.",
  },
  {
    icon: Smartphone,
    ...
    frequency: "Ежемесечно (ръчна проверка)",
    method:
      "21 мобилни плана (7 на оператор) са събрани от публичните тарифни страници. Включват месечна цена, GB данни, минути, SMS, тип (предплатен/абонамент) и допълнителни услуги. Сравнението показва най-евтиния план по зададени критерии.",
  },
  {
    icon: Scale,
    title: "Покупателна способност",
    source: "Потребителска кошница (КНСБ) + Eurostat (earn_mw_cur) + статични данни (ток, вода, горива)",
    url: null,
    frequency: "Месечно (кошница) + автоматично (Eurostat заплати)",
    method:
      "Изчисляваме колко единици от ключови продукти (хляб, мляко, бензин, kWh ток) може да купи минималната и средна заплата. За ЕС сравнението зареждаме минимални заплати от Eurostat и сравняваме брой кошници, които купува МРЗ в различните страни.",
  },
];
    ...
    <div className="mx-auto max-w-3xl px-4 py-8">
      ...
      <div className="space-y-8 text-text">
        ...
        <div className="rounded-xl border border-border bg-surface p-5">
          ...
          <p className="text-sm text-muted">
            Секциите БВП, Инфлация, България vs ЕС и Покупателна способност
            зареждат данни директно от Eurostat REST API с интервал на обновяване
            от 24 часа (revalidate). Това означава, че когато Eurostat публикува
            нови данни, те ще се появят на Спести в рамките на един ден — без
            ръчна намеса.
          </p>
        </div>
