...
const releases: ReleaseEntry[] = [
  ...
  },
  {
    ...
    description:
      "Нови дълги статии насочени към потребители, търсещи слънчеви панели, разходи за кола, отопление и личен финансов профил — с вградени линкове към съответните калкулатори.",
    icon: <BookOpen className="h-5 w-5" />,
    color: "text-blue-600 bg-blue-100",
    changes: [
      {
        type: "new",
        text: "Статия: 'Изплащат ли се слънчевите панели за 2026?' — ROI, net metering, 4 сценария → /slanchevi-paneli",
      },
      {
        type: "new",
        text: "Статия: 'Колко ме струва колата на месец?' — гориво, ГО, КАСКО, данък, амортизация, кола vs транспорт → /kola",
      },
      {
        type: "new",
        text: "Статия: 'Отопление с ток, газ или климатик?' — климатикът е 3× по-евтин, реални числа за 2026 → /otoplenie",
      },
      {
        type: "new",
        text: "Статия: 'Как да разбереш за какво харчиш парите си?' — наръчник за личния финансов профил → /profil",
      },
    ],
  },
  {
