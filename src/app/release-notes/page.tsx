...
const releases: ReleaseEntry[] = [
  {
    ...
    title: "3 нови SEO статии в блога",
    description:
      "Нови дълги статии насочени към потребители, търсещи слънчеви панели, разходи за кола и личен финансов профил — с вградени линкове към съответните калкулатори.",
    icon: <BookOpen className="h-5 w-5" />,
    color: "text-blue-600 bg-blue-100",
    changes: [
      {
        type: "new",
        text: "Статия: 'Изплащат ли се слънчевите панели в България за 2026?' — реална калкулация с числа, ROI, net metering и линк към /slanchevi-paneli",
      },
      {
        type: "new",
        text: "Статия: 'Колко ме струва колата на месец? Пълна разбивка 2026' — гориво, ГО, КАСКО, данък, амортизация, сравнение с такси/транспорт",
      },
      {
        type: "new",
        text: "Статия: 'Как да разбереш за какво харчиш парите си?' — наръчник за личния финансов профил с cross-links към 7 калкулатора",
      },
    ],
  },
  {
    version: "0.18.1",
    date: "20 февруари 2026",
    title: "Хибридно въвеждане в Финансов Профил",
    description:
      "Добавена опция за ръчно въвеждане на реални сметки в /profil — автоматичните изчисления са запазени като базова стойност, а потребителят може да ги прецизира с реалните си данни.",
    icon: <Sparkles className="h-5 w-5" />,
    color: "text-emerald-600 bg-emerald-100",
    changes: [
      {
        type: "improved",
        text: "Финансов профил: добавена секция 'Реални сметки' с 8 незадължителни inputs (ток, вода, газ, интернет, мобилен, гориво, храна, застраховки)",
      },
      {
        type: "improved",
        text: "Ако въведеш реална стойност, тя замества автоматичното изчисление — зелен индикатор показва кои категории са въведени ръчно",
      },
      {
        type: "improved",
        text: "Профилът помни ръчно въведените стойности (localStorage v2) — при следващо посещение всичко е запазено",
      },
      {
        type: "improved",
        text: "Бутон 'Изчисти всички ръчни стойности' — reset до автоматичния режим с едно натискане",
      },
    ],
  },
  {
    version: "0.18.0",
    date: "20 февруари 2026",
    title: "Личен Финансов Профил + Нова начална страница",
    description:
      "Killer feature: персонализиран финансов профил за домакинството — пълна месечна картина, лична инфлация, работни дни за всяка сметка и препоръки за спестяване. Начална страница с 4 логически групи.",
    icon: <Sparkles className="h-5 w-5" />,
    color: "text-violet-600 bg-violet-100",
    changes: [
      {
        type: "new",
        text: "Личен Финансов Профил (/profil) — въведи домакинството си веднъж и виж ток + вода + газ + гориво + храна + застраховки на едно място",
      },
      {
        type: "new",
        text: "Времева цена: виж колко работни дни от месеца изкарваш само за сметки (по категория)",
      },
      {
        type: "new",
        text: "Лична инфлация — твоята реална инфлация спрямо структурата на разходите (не националната средна)",
      },
      {
        type: "new",
        text: "Персонализирани препоръки за спестяване с конкретни суми (до X EUR/месец)",
      },
      {
        type: "new",
        text: "Сравнение Ти vs. средно за България по 8 категории (bar chart)",
      },
      {
        type: "improved",
        text: "Начална страница: 4 логически групи (Сметки, Транспорт, Финанси, Анализи) вместо плоска листа",
      },
      {
        type: "improved",
        text: "\"Комбиниран калкулатор\" преименуван на \"Базови сметки\" — по-ясно и кратко",
      },
      {
        type: "improved",
        text: "Навигация: \"Всичко\" премахнато, заменено с бутон ✨ Профил + Базови сметки влиза в Сметки dropdown",
      },
      {
        type: "improved",
        text: "Hero секцията: два бутона — Сравни сметки + Моят финансов профил",
      },
    ],
  },
  {
    version: "0.17.0",
    date: "20 февруари 2026",
    title: "4 нови калкулатора: Разбивка, Соларни, Кола, Вода",
    description:
      "Разбивка на сметката за ток/газ/вода, ROI калкулатор за слънчеви панели, пълна цена на притежание на автомобил и сравнение на водата в 22 града.",
    icon: <Receipt className="h-5 w-5" />,
    color: "text-emerald-600 bg-emerald-100",
    changes: [
      {
        type: "new",
        text: "Разбивка на сметката — виж какъв % от ток/газ/вода отива за производство, пренос, разпределение и данъци (PieChart + регионално сравнение)",
      },
      {
        type: "new",
        text: "Слънчеви панели — ROI калкулатор: покривна площ → мощност, годишно производство, срок на изплащане и 25-годишни спестявания с net metering",
      },
      {
        type: "new",
        text: "Цена на колата — пълна месечна разбивка: гориво, ГО, КАСКО, данък, винетка, ГТП, поддръжка и амортизация (бензин/дизел/LPG/електро)",
      },
      {
        type: "new",
        text: "Вода по градове — класация на 22 града по цена на водата с breakdown на доставка, канализация и пречистване",
      },
      {
        type: "improved",
        text: "Начална страница с 4 нови категории (общо 23 калкулатора)",
      },
      {
        type: "improved",
        text: "Навигация, Footer, Sitemap и Service Worker обновени с новите URLs",
      },
    ],
  },
  {
